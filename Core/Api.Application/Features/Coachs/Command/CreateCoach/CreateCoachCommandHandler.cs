...
{
    public class CreateCoachCommandHandler : IRequestHandler<CreateCoachCommandRequest>
    {
        ...
        public async Task Handle(CreateCoachCommandRequest request, CancellationToken cancellationToken)
        {
