...
{
    public class UpdateGymnastCommandHandler : IRequestHandler<UpdateGymnastCommandRequest>
    {
        ...
        public async Task Handle(UpdateGymnastCommandRequest request, CancellationToken cancellationToken)
        {
