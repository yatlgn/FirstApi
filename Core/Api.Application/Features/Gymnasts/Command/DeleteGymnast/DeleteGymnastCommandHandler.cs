...
{
    public class DeleteGymnastCommandHandler : IRequestHandler<DeleteGymnastCommandRequest>
    {
        ...
        public async Task Handle(DeleteGymnastCommandRequest request, CancellationToken cancellationToken)
        {
